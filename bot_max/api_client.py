...
class ApiClient:
    ...
    async def register_user(self, user_id: int, nickname: str | None = None) -> dict[str, Any]:
        session = await self._get_session()
        # MAX user_id used as telegram_id — same int64 field, different platform
    ...
    async def submit_report(
        ...
        *,
        ...
        form.add_field("telegram_id", str(user_id))
